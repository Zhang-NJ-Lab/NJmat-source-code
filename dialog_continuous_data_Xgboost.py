...
# Form implementation generated from reading ui file 'dialog_continuous_data_Xgboost.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_2.addWidget(self.buttonBox, 14, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_2.setText(_translate("Dialog", "200"))
        ...
        self.lineEdit_6.setText(_translate("Dialog", "0.8"))
        self.label_6.setText(_translate("Dialog", "subsample"))
        self.label_5.setText(_translate("Dialog", "colsample_bytree"))
        self.label.setText(_translate("Dialog", "n_estimators"))
        self.lineEdit_5.setText(_translate("Dialog", "0.9"))
        self.label_7.setText(_translate("Dialog", "learning_rate"))
        self.label_3.setText(_translate("Dialog", "eta"))
        self.label_4.setText(_translate("Dialog", "gamma"))
        self.lineEdit.setText(_translate("Dialog", "1000"))
        self.lineEdit_7.setText(_translate("Dialog", "0.2"))
