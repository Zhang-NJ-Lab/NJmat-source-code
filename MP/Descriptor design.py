...
class FileSelectionWidget(QWidget):
    ...
    def executeCode(self):
        if hasattr(self, 'folder_path') and hasattr(self, 'save_path'):
            ...
            fieldnames = ['formula', 'element1_x', 'element1_y', 'element1_z', 'element2_x', 'element2_y', 'element2_z',
                          'element3_x',
                          'element3_y', 'element3_z', 'element4_x', 'element4_y', 'element4_z', 'element5_x',
                          'element5_y',
                          'element5_z', 'element1_abundance_crust', 'element1_abundance_sea', 'element1_atomic_number',
                          'element1_atomic_radius', 'element1_atomic_radius_rahm',
                          'element1_atomic_volume', 'element1_atomic_weight', 'element1_atomic_weight_uncertainty',
                          'element1_block',
                          ...
                          'element1_covalent_radius_pyykko_double', 'element1_covalent_radius_pyykko_triple',
                          'element1_cpk_color',
                          'element1_density',
                          'element1_description', 'element1_dipole_polarizability',
                          'element1_dipole_polarizability_unc',
                          'element1_discoverers', 'element1_discovery_location', 'element1_discovery_year',
                          'element1_ec',
                          'element1_econf', 'element1_electron_affinity', 'element1_en_allen', 'element1_en_ghosh',
                          'element1_en_pauling', 'element1_evaporation_heat', 'element1_fusion_heat',
                          'element1_gas_basicity',
                          'element1_geochemical_class', 'element1_glawe_number', 'element1_goldschmidt_class',
                          'element1_group',
                          'element1_group_id', 'element1_heat_of_formation',
                          'element1_is_monoisotopic', 'element1_is_radioactive', 'element1_isotopes',
                          'element1_jmol_color',
                          ...
                          'element1_molar_heat_capacity', 'element1_molcas_gv_color', 'element1_name',
                          'element1_name_origin',
                          'element1_period', 'element1_pettifor_number', 'element1_phase_transitions',
                          'element1_proton_affinity',
                          'element1_screening_constants', 'element1_sources',
                          'element1_specific_heat_capacity', 'element1_symbol', 'element1_thermal_conductivity',
                          'element1_uses',
                          ...
                          'element1_vdw_radius_uff', 'element2_abundance_crust', 'element2_abundance_sea',
                          'element2_atomic_number', 'element2_atomic_radius', 'element2_atomic_radius_rahm',
                          'element2_atomic_volume', 'element2_atomic_weight', 'element2_atomic_weight_uncertainty',
                          'element2_block',
                          ...
                          'element2_covalent_radius_pyykko_double', 'element2_covalent_radius_pyykko_triple',
                          'element2_cpk_color',
                          'element2_density',
                          'element2_description', 'element2_dipole_polarizability',
                          'element2_dipole_polarizability_unc',
                          'element2_discoverers', 'element2_discovery_location', 'element2_discovery_year',
                          'element2_ec',
                          'element2_econf', 'element2_electron_affinity', 'element2_en_allen', 'element2_en_ghosh',
                          'element2_en_pauling', 'element2_evaporation_heat', 'element2_fusion_heat',
                          'element2_gas_basicity',
                          'element2_geochemical_class', 'element2_glawe_number', 'element2_goldschmidt_class',
                          'element2_group',
                          'element2_group_id', 'element2_heat_of_formation',
                          'element2_is_monoisotopic', 'element2_is_radioactive', 'element2_isotopes',
                          'element2_jmol_color',
                          ...
                          'element2_molar_heat_capacity', 'element2_molcas_gv_color', 'element2_name',
                          'element2_name_origin',
                          'element2_period', 'element2_pettifor_number', 'element2_phase_transitions',
                          'element2_proton_affinity',
                          'element2_screening_constants', 'element2_sources',
                          'element2_specific_heat_capacity', 'element2_symbol', 'element2_thermal_conductivity',
                          'element2_uses',
                          ...
                          'element2_vdw_radius_uff', 'element3_abundance_crust', 'element3_abundance_sea',
                          'element3_atomic_number', 'element3_atomic_radius', 'element3_atomic_radius_rahm',
                          'element3_atomic_volume', 'element3_atomic_weight', 'element3_atomic_weight_uncertainty',
                          'element3_block',
                          ...
                          'element3_covalent_radius_pyykko_double', 'element3_covalent_radius_pyykko_triple',
                          'element3_cpk_color',
                          'element3_density',
                          'element3_description', 'element3_dipole_polarizability',
                          'element3_dipole_polarizability_unc',
                          'element3_discoverers', 'element3_discovery_location', 'element3_discovery_year',
                          'element3_ec',
                          'element3_econf', 'element3_electron_affinity', 'element3_en_allen', 'element3_en_ghosh',
                          'element3_en_pauling', 'element3_evaporation_heat', 'element3_fusion_heat',
                          'element3_gas_basicity',
                          'element3_geochemical_class', 'element3_glawe_number', 'element3_goldschmidt_class',
                          'element3_group',
                          'element3_group_id', 'element3_heat_of_formation',
                          'element3_is_monoisotopic', 'element3_is_radioactive', 'element3_isotopes',
                          'element3_jmol_color',
                          ...
                          'element3_molar_heat_capacity', 'element3_molcas_gv_color', 'element3_name',
                          'element3_name_origin',
                          'element3_period', 'element3_pettifor_number', 'element3_phase_transitions',
                          'element3_proton_affinity',
                          'element3_screening_constants', 'element3_sources',
                          'element3_specific_heat_capacity', 'element3_symbol', 'element3_thermal_conductivity',
                          'element3_uses',
                          ...
                          'element3_vdw_radius_uff', 'element4_abundance_crust', 'element4_abundance_sea',
                          'element4_atomic_number', 'element4_atomic_radius', 'element4_atomic_radius_rahm',
                          'element4_atomic_volume', 'element4_atomic_weight', 'element4_atomic_weight_uncertainty',
                          'element4_block',
                          ...
                          'element4_covalent_radius_pyykko_double', 'element4_covalent_radius_pyykko_triple',
                          'element4_cpk_color',
                          'element4_density',
                          'element4_description', 'element4_dipole_polarizability',
                          'element4_dipole_polarizability_unc',
                          'element4_discoverers', 'element4_discovery_location', 'element4_discovery_year',
                          'element4_ec',
                          'element4_econf', 'element4_electron_affinity', 'element4_en_allen', 'element4_en_ghosh',
                          'element4_en_pauling', 'element4_evaporation_heat', 'element4_fusion_heat',
                          'element4_gas_basicity',
                          'element4_geochemical_class', 'element4_glawe_number', 'element4_goldschmidt_class',
                          'element4_group',
                          'element4_group_id', 'element4_heat_of_formation',
                          'element4_is_monoisotopic', 'element4_is_radioactive', 'element4_isotopes',
                          'element4_jmol_color',
                          ...
                          'element4_molar_heat_capacity', 'element4_molcas_gv_color', 'element4_name',
                          'element4_name_origin',
                          'element4_period', 'element4_pettifor_number', 'element4_phase_transitions',
                          'element4_proton_affinity',
                          'element4_screening_constants', 'element4_sources',
                          'element4_specific_heat_capacity', 'element4_symbol', 'element4_thermal_conductivity',
                          'element4_uses',
                          ...
                          'element4_vdw_radius_uff', 'element5_abundance_crust', 'element5_abundance_sea',
                          'element5_atomic_number', 'element5_atomic_radius', 'element5_atomic_radius_rahm',
                          'element5_atomic_volume', 'element5_atomic_weight', 'element5_atomic_weight_uncertainty',
                          'element5_block',
                          ...
                          'element5_covalent_radius_pyykko_double', 'element5_covalent_radius_pyykko_triple',
                          'element5_cpk_color',
                          'element5_density',
                          'element5_description', 'element5_dipole_polarizability',
                          'element5_dipole_polarizability_unc',
                          'element5_discoverers', 'element5_discovery_location', 'element5_discovery_year',
                          'element5_ec',
                          'element5_econf', 'element5_electron_affinity', 'element5_en_allen', 'element5_en_ghosh',
                          'element5_en_pauling', 'element5_evaporation_heat', 'element5_fusion_heat',
                          'element5_gas_basicity',
                          'element5_geochemical_class', 'element5_glawe_number', 'element5_goldschmidt_class',
                          'element5_group',
                          'element5_group_id', 'element5_heat_of_formation', 'element5_is_monoisotopic',
                          'element5_is_radioactive', 'element5_isotopes', 'element5_jmol_color',
                          ...
                          'element5_molar_heat_capacity', 'element5_molcas_gv_color', 'element5_name',
                          'element5_name_origin',
                          'element5_period', 'element5_pettifor_number', 'element5_phase_transitions',
                          'element5_proton_affinity',
                          'element5_screening_constants', 'element5_sources',
                          'element5_specific_heat_capacity', 'element5_symbol', 'element5_thermal_conductivity',
                          'element5_uses',
