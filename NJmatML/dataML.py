...
# 0 描述符导入
# 0.1 有机分子描述符导入（NJmatML提供了rdkit描述符）
# 0.1.2 rdkit描述符
...
def dnn_regressor_modify(epochs, batch_size, validation_split, path, csvname,cross):
    ...
    plt.gcf().text(0.0, -0.3, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2),
                   ...
                   size=20, horizontalalignment='center')
    plt.savefig(path + '/DNN-modify-test.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    if cross >= 2:
        ...
        for train, val in kfold.split(X_train, y_train):
            ...
            scores.append(model.evaluate(X_train[val], y_train[val], verbose=0)[1])  # 取MAE

        print("scores:", scores)
        scores = np.array(scores)
        scores_fold = []
        for i in range(len(scores)):
            scores_mean = np.mean(scores[:i + 1])
            print(i + 1, "scores_mean:", scores_mean)
            scores_fold.append(scores_mean)
        ...
        plt.xlabel("k", fontproperties='Times New Roman', size=24)
        plt.ylabel("score", fontproperties='Times New Roman', size=24)
        file_set_name='DNN_modify-' + str(cross) + '-fold-crossvalidation.png'
        plt.savefig(path + '/' + file_set_name, dpi=300, bbox_inches='tight')
        plt.close()
    else:
        scores = [-1]
    ...
    plt.gcf().text(0.0, -0.3, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE_train, MSE_train, R2_train),
                   fontproperties='Times New Roman', size=20, horizontalalignment='center')
    plt.savefig(path + '/DNN-modify-train.png', dpi=300, bbox_inches='tight')
    plt.close()

    model.save(path + "/DNN_model.h5")
    return str1, scores, str2

def cnn_regressor_modify(epochs, batch_size, validation_split, path, csvname, cross):
    # epochs: number of epochs
    # batch_size: size of the batch
    # validation_split: fraction of the training data to be used as validation data
    from sklearn import preprocessing
    ...
    # Build the CNN model
    model = Sequential()
    model.add(Conv2D(32, (3, 1), activation='relu', padding='same', input_shape=(X_train.shape[1], X_train.shape[2], X_train.shape[3])))
    ...
    plt.gcf().text(0.0, -0.3, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties='Times New Roman',
                   size=20, horizontalalignment='center')
    plt.savefig(path + '/CNN-modify-test.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    if cross >= 2:
        ...
        plt.xlabel("k", fontproperties='Times New Roman', size=24)
        plt.ylabel("score", fontproperties='Times New Roman', size=24)
        file_set_name = 'CNN_modify-' + str(cross) + '-fold-crossvalidation.png'
        plt.savefig(path + '/' + file_set_name, dpi=300, bbox_inches='tight')
        plt.close()
    else:
        scores = [-1]
    ...
    plt.gcf().text(0.0, -0.3, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE_train, MSE_train, R2_train),
                   fontproperties='Times New Roman', size=20, horizontalalignment='center')
    plt.savefig(path + '/CNN-modify-train.png', dpi=300, bbox_inches='tight')
    plt.close()

    model.save(path + "/CNN_model.h5")
    return str1, scores, str2

def rnn_regressor_modify(epochs, batch_size, validation_split, path, csvname, cross):
    # epochs: number of epochs
    # batch_size: size of the batch
    # validation_split: fraction of the training data to be used as validation data
    from sklearn import preprocessing
    ...
    plt.gcf().text(0.0, -0.3, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE, MSE, R2), fontproperties='Times New Roman',
                   size=20, horizontalalignment='center')
    plt.savefig(path + '/RNN-modify-test.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    if cross >= 2:
        ...
        plt.xlabel("k", fontproperties='Times New Roman', size=24)
        plt.ylabel("score", fontproperties='Times New Roman', size=24)
        file_set_name = 'RNN_modify-' + str(cross) + '-fold-crossvalidation.png'
        plt.savefig(path + '/' + file_set_name, dpi=300, bbox_inches='tight')
        plt.close()
    else:
        scores = [-1]
    ...
    plt.gcf().text(0.0, -0.3, 'MAE = %.3f \nMSE =  %.3f \nR2 =  %.3f \n' % (MAE_train, MSE_train, R2_train),
                   fontproperties='Times New Roman', size=20, horizontalalignment='center')
    plt.savefig(path + '/RNN-modify-train.png', dpi=300, bbox_inches='tight')
    plt.close()

    model.save(path + "/RNN_model.h5")
    return str1, scores, str2
