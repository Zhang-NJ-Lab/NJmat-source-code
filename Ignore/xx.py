descriptor_list = [
    ...
    'fr_Al_COO', 'fr_Al_OH', 'fr_Al_OH_noTert', 'fr_ArN', 'fr_Ar_COO', 'fr_Ar_N', 'fr_Ar_NH', 'fr_Ar_OH', 'fr_COO',
...
# Print descriptors with the Descriptors. prefix and (x) suffix
for descriptor in descriptor_list:
    print(f"Descriptors.{descriptor}(x),")
